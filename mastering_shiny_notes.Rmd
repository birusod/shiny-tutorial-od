...
Outputs in the UI create placeholders, later filled by the server function. 

Outputs take a unique ID as their first arg (outputId): ID "plot" => output$plot.

Each output func on the front end is coupled with a render func in the back end.

 There are three main types of output: text, tables, and plots. 
...
- Plots: You can display any type of R graphic (base, ggplot2, or otherwise)      - *plotOutput()* => *renderPlot()*
